...
For the first step of a task, always start with focusing the relevant app to the front of the screen. Always do that first. Be sure to not only open the app, but to focus it.
