...
For the first step of a task, always start with focusing the relevant app to the front of the screen. Always do that first. Be sure to not only open the app, but to focus it. You are also told what app the user is currently focusing on. Never close an app or delete anything, but instead just bring the relevant app to the front.
